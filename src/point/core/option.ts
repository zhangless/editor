...
export type IOptions = {
    ...
    watcherHeatmap: boolean
}

/**
 * 对用户传入的options进行类型检查  格式化
*/
export function parseOption(options: Partial<IOptions>): IOptions {
    ...
    initOptions.watcherHeatmap = watcherHeatmap || false
    return initOptions
}